...
% Send the Logistics/Week0Annoucnement.
% Send an email reminding students to bring a charged computer.
...
$\:$ \\
\includegraphics[width=0.85\textwidth]{figures/course_webpage1.png} \\
... \\
\includegraphics[width=0.85\textwidth]{figures/course_webpage2.png}
...
{\footnotesize
\begin{itemize}[<alert@+>]
\item Recognize the importance of data collection, identify limitations in data 
collection methods, and determine how they affect the scope of inference.
\item Use statistical software to summarize data numerically and visually, and to 
perform data analysis.
\item Have a conceptual understanding of the unified nature of statistical inference.
\item Apply estimation and testing methods to analyze single variables or the 
relationship between two variables in order to understand natural phenomena and make 
data-based decisions.
\item Model numerical response variables using a single or multiple explanatory 
variables.
\item Interpret results correctly, effectively, and in context without relying on 
statistical jargon.
\item Critique data-based claims and evaluate data-based decisions.
\item Complete two research projects: one that focuses on statistical inference and 
one that focuses on modeling. 
\end{itemize}
}
...
\red{Objective:} Help you develop a more in-depth understanding of the material and 
...
\red{Objective:} Give you hands on experience with data analysis using statistical 
software and provide you with tools for the projects.
...
\item Go to the course website, \webURL{\CourseSite}, click on the RStudio link (top 
right)
\begin{itemize}
\item {\footnotesize Make sure you're on the Duke network, not visitor}
\end{itemize}
\item Log in using your Net ID and password
\item In the Console, generate a random number between 1 and 5, and introduce yourself 
to that many people sitting around you:
...
\red{Objective:} Encourage you to watch the videos and/or complete the reading 
...
\red{Objective:} Evaluate your mastery of the material by the end of a unit and give 
...
Regrade requests must be made \hl{within 3 days} of when the assignment is returned, 
and must be submitted to me in writing.

\begin{itemize}

\item These will be honored if points were tallied incorrectly, or if you feel your 
answer is correct but it was marked wrong.
...
%
%\begin{center}
%\includegraphics[width=0.8\textwidth]{figures/babynames2014.png}
%\end{center}
%
...
%\end{center}
%% ALT ALT
%  % Can replace with image for own name
%
...
%
%\begin{center}
%\includegraphics[width=0.7\textwidth]{figures/silver-feature-most-common-women-names3.png}
%\end{center}
%
%%---Note---%
%\note{
...
%
%\begin{center}
%\includegraphics[width=\textwidth]{figures/silver-feature-youngest-women-names3.png}
%\end{center}
%
%%---Notes---%
%\note{
