...
\item I don't have OH this week, but I will be available on Piazza to answer any questions

\item Problem set (PS) 1 is due Friday night (11:55pm)

\item Performance assessment (PA) 1 is due Sunday night (11:55pm)

\item Readiness assessment (RA) 2 is next Monday, so start reviewing resources for Unit 2 later this week
