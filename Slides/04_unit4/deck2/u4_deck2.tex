...
\item Feedback from midterm evaluation: $n = 10$ :( or :)?
\begin{itemize}
\item Majority think pace is about right
\item Majority like videos and application exercises
\item Majority like flipped / team-based aspect, though feelings on teams not unanimous
\end{itemize}

\item Read the project instructions one more time before lab tomorrow, and
...
\pause
\begin{center}
\includegraphics[width = \textwidth]{figures/movies/t_90}
\end{center}
}

\soln{\[ 43.5 \pm (1.66 \times 4.88) = (35.4, 51.6) \] }
