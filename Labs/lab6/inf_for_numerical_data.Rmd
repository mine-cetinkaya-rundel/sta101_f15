...
download("http://stat.duke.edu/courses/Fall15/sta101.002/rmd/lab6.Rmd", 
         destfile = "lab6.Rmd")
```
</div>
...
```{r load-inference}
load(url("https://stat.duke.edu/~mc301/R/inference.RData"))
```
...
smoking mothers, and interpret this interval in context of the data.
...
to the function: `conflevel = 0.90`. Comment on the width of this interval versus 
