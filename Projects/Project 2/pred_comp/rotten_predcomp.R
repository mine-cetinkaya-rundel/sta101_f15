...
best_pic_wins = read.csv("../data/best_pic_wins.csv", stringsAsFactors = FALSE)
...
best_actor_wins = read.csv("../data/best_actor_wins.csv", stringsAsFactors = FALSE)
...
best_actress_wins = read.csv("../data/best_actress_wins.csv", stringsAsFactors = FALSE)
...
best_dir_wins = read.csv("../data/best_dir_wins.csv", stringsAsFactors = FALSE)
...
# final save
movies_pred = d_fin2
save(movies_pred, file = "movies_pred.Rdata")